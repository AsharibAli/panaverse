      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
            <Link href="https://github.com/panaverse" passHref={true}>
              <a target="_blank" rel="noopener noreferrer" className="text-black-600 mx-2 sm:mx-4 capitalize tracking-wide hover:text-orange-500 transition-all">
                Github
              </a>
            </Link>

            <Link href="https://portal.piaic.org/signup" passHref={true}>
