        ...
        >
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
              Build and Empower the Web Space <strong>Panaverse</strong>.
            </h1>
            <p className="text-black-500 mt-4 mb-6">
              Panaverse mission is to train cutting-edge technologies like (Web
              3.0, Metaverse, Artificial Intelligence (AI), Cloud, Edge, Ambient
              Computing/IoT, Network Automation, and Bioinformatics) across
